        ...
        <div>
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
                    ...
                    <div className="md:max-w-96">
                        <img className="h-9" src={assets.logo} alt="logo"/>
                            <p className="mt-6 text-sm">
                               Experience the power of AI with SwiftAi.<br/>Transform your content creation with our suit of premium AI tools. Write article, generate images, and enhance your workflow.
                            </p>
                    </div>
                ...
                <p className="pt-4 text-center text-xs md:text-sm pb-5">
                    Copyright {year} © <a href="https://prebuiltui.com">Swift Ai</a>. All Right Reserved.
                </p>
            </footer>
        </div>
    )
